      ...
      <section className="py-5 bg-light">
        <div className="container px-5 my-5">
          ...
          <div className="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-4 justify-content-center">
            {[
              { name: 'Ibbie Eckart', title: 'Founder & CEO' },
              { name: 'Arden Vasek', title: 'CFO' },
              { name: 'Toribio Nerthus', title: 'Operations Manager' },
              { name: 'Malvina Cilla', title: 'CTO' },
            ].map((m, idx) => (
              <div key={idx} className="col mb-5 mb-5 mb-xl-0">
                <div className="text-center">
                  ...
                  <div className="fst-italic text-muted">{m.title}</div>
                </div>
              </div>
            ))}
          </div>
