    ...
    <section className="py-5">
      <div className="container px-5 my-5">
        <div className="text-center mb-5">
          <h1 className="fw-bolder">{t('faq.pageTitle')}</h1>
          <p className="lead fw-normal text-muted mb-0">{t('faq.pageSubtitle')}</p>
        </div>
        <div className="row gx-5">
          <div className="col-xl-8">
            <h2 className="fw-bolder mb-3">{t('faq.accountBilling')}</h2>
            ...
            <h2 className="fw-bolder mb-3">{t('faq.websiteIssues')}</h2>
